...
The workflow of our system, starting from the train collection provided by \ac{LongEval} \cite{cleflongeval}, is as follows:
\begin{enumerate}
...
\begin{figure}[!h]
    \includegraphics[height=\textheight, angle =90, keepaspectratio]{figure/Classes_diagram_white.pdf}
