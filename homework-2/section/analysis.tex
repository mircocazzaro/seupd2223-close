...
%        \centering
%        \includegraphics[width=\linewidth]{figure/StatisticalAnalysis/ANOVA 2/ndcg-lt-fr.jpeg}
%        \caption{Interpolation for Data 1}\label{Fig:Data1}
%    \end{minipage}\hfill
%    \begin{minipage}{0.48\textwidth}
%        \centering
%        \includegraphics[width=\linewidth]{figure/StatisticalAnalysis/ANOVA 2/ap-lt-fr.jpeg}
