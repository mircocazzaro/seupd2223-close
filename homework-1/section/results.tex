...
The very first big milestone, that helped us to increment the MAP of around 3.5 points, was the JavaScript code cleaner, since we noticed by inspection that many documents were having JS scripts inside.\\
